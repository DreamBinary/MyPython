...
#dows是的chromedriver
chromedriver_path = "D:\MyPython\msedgedriver.exe"
...
url = "https://wenku.baidu.com/view/5f24883c580216fc700afda9?aggId=3661f4daa58da0116c17494b&fr=catalogMain&_wkts_=1669619127670"
...
class StartChrome():
    def __init__(self):
        ...
        self.brower = webdriver.Edge(executable_path=chromedriver_path)
        # 启动浏览器，打开需要下载的网页
        self.brower.get(url)
